        ...
        >
          <div className="flex w-full justify-between h-screen">
            ...
            <div className="w-381px relative pl-33px pad:w-[300px!ignore]  overflow-hidden pr-33px pad:pl-24px pad:pr-24px pad:w-272px mobile:w-full mobile:pl-20px mobile:pr-18px bg-[#FFFFFF]">
              ...
              <div className="text-center not-italic font-semibold text-[#000000] font-GalanoGrotesque  text-22px pad:text-16px mobile:text-20px mt-68px pad:mt-48px mobile:mt-53px">
                {headerData.regionSwitchingPromptWords}
              </div>
              ...
              <div className="uppercase font-semibold font-Grotesque-Medium tetx-[#000000]  not-italic text-15px pad:text-11px mobile:text-17px mt-68px pad:mt-48px mobile:mt-53px">
