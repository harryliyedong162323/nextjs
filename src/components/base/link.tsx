...
interface propsContent {
  ...
  onHover?: (
    enter: (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => void,
    leave: (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => void
  ) => void;
}
...
class BaseLink extends Component<propsContent, State> {
  ...
  leavePageAnalytics() {
    ...
    const scrollSlug: string | undefined =
      scrollDom.getAttribute("data-slug") || "";
  ...
  computedLink(): string {
    let location: string | undefined =
      this.getLocation() || process.env.LOCATION;
    ...
    targetUrl = this.props.autoLanguage
      ? process.env.DOMAIN + this.props.link
      : this.props.link;
