                ...
                <div className="grid grid-cols-3 place-items-center mobile:grid-rows-3 mobile:grid-cols-none">
                    <div className="self-center">
                        <div className="w-155px h-32px pad:w-110px pad:h-22px relative  mobile:w-167px mobile:h-204px">
                            <BaseImage
                                mImg={digitalExperienceData.digitalExperienceComponentDigitalLeftImage.imagemobile.url}
                                pImg={digitalExperienceData.digitalExperienceComponentDigitalLeftImage.imagepc.url}
                                alt={digitalExperienceData.digitalExperienceComponentDigitalLeftImage.altText}
                                layout="fill"
                                objectFit="contain"
                                quality={100}
                            ></BaseImage>
                    ...
                    <div className=" relative self-center  text-center">
                        <div className={`w-137px h-137px relative mx-auto pad:w-97px pad:h-97px mobile:w-125px mobile:h-89px`}>
                            <BaseImage

                                mImg={digitalExperienceData.digitalExperienceComponentDigitalMiddleImage.imagemobile.url}
                                pImg={digitalExperienceData.digitalExperienceComponentDigitalMiddleImage.imagepc.url}
                                alt={digitalExperienceData.digitalExperienceComponentDigitalMiddleImage.altText}
                                layout="fill"
                                objectFit="contain"
                                quality={100}
                            ></BaseImage>
                   ...
                   <div className="self-center">
                       <div className="w-218px h-32px pad:w-110px pad:h-22px relative  mobile:w-125px mobile:h-89px">
                           <BaseImage
                               mImg={digitalExperienceData.digitalExperienceComponentDigitalRightImage.imagemobile.url}
                               pImg={digitalExperienceData.digitalExperienceComponentDigitalRightImage.imagepc.url}
                               alt={digitalExperienceData.digitalExperienceComponentDigitalRightImage.altText}
                               layout="fill"
                               objectFit="contain"
                               quality={100}
                           ></BaseImage>
