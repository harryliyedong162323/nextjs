  ...
  return (
    <section id="ServingSuggestion" data-anchor={2} className="relative overflow-hidden bg-[#E6E7E8] select-none">
      ...
      <div className="flex h-screen flex-col">
        ...
        <div className="font-Grotesque-Regular text-center text-[#696969] mt-20px text-20px pad:text-16px mobile:text-14px mobile:mt-20px mobile:px-50px">
          Ideal enjoyed neat or slightly chilled with a cube of ice.
        </div>
        <div className="flex justify-between mx-auto mt-20px w-[1250px] pad:w-1000px mobile:w-full mobile:flex-col mobile:px-0">
          <div className="w-615px h-524px pad:w-492px pad:h-418px mobile:w-full mobile:h-270px mobile:mt-40px">
            <Image
              className="object-cover w-full h-412px pad:h-328px mobile:w-full mobile:h-200px"
          ...
          <div className="w-593px h-524px pad:w-474px pad:h-418px mobile:w-full mobile:mt-20px">
            <Image
