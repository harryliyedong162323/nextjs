          ...
          <SwiperSlide>
            <>
              ...
              >
                ...
                <span style={textGradient} className="text-[#d28656] font-AlbertusNova-Regular uppercase leading-none text-58px my-34px pad:text-46px pad:my-27px mobile:text-32px mobile:w-full mobile:my-20px">
