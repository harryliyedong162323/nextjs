        ...
        <section className="relative h-screen bg-cover bg-[url('/assets/VIPClub/bg.png')] bg-black overflow-hidden select-none">
            ...
            <div className="relative container mx-auto">
                ...
                <div className="grid grid-cols-3 place-items-center mobile:grid-rows-3 mobile:grid-cols-none">
                    <div className="w-283px h-245px relative self-center paid:w-202px paid:h-175px mobile:w-315px mobile:h-130px mobile:mb-46px">
                        <BaseImage
                    ...
                    <div className="w-283px h-245px relative self-center paid:w-202px paid:h-175px mobile:w-315px mobile:h-129px">
                        <BaseImage
