...
function TalesFromTheWildComponent(props: any) {
  ...
  return (
    <div id="TalesFromTheWild" className="relative overflow-hidden bg-[#E6E7E8]">
      <div className="flex h-screen flex-col">
        ...
        <div className="mx-auto inline-flex justify-between mt-84px w-[1250px] h-516px paid:mt-67px paid:w-1000px paid:h-414px mobile:w-full mobile:flex-col mobile:px-0 mobile:mt-10px">
          { kolList?.length > 0 && kolList.map((item, index) => {
            return (
      ...
      <div className="w-full absolute bottom-20px z-20 font-Grotesque-Regular text-[#969797] uppercase text-20px paid:text-14px mobile:text-10px" >
        <div className="flex justify-between mx-auto w-[1250px] paid:w-1000px mobile:w-full text-center">
          <a href="#ProductsFamily" className="inline-block mobile:w-64px">products family</a>
          <a href="#TalesFromTheWild" className="relative inline-block text-[#696969] mobile:w-64px mobile:text-white">
            Tales From The Wild
          ...
          <a href="#ServingSuggestion" className="inline-block mobile:w-64px">Serving  Suggestion</a>
          <a href="#BottleConcept" className="inline-block mobile:w-64px">Bottle  Concept</a>
          <a href="#FlavourFinder" className="inline-block mobile:w-64px">Flavour Finder</a>
        </div>
      </div>
    </div>
  );
