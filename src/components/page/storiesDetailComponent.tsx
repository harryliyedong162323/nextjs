      ...
      <div className="w-full h-407px overflow-hidden relative mobile:hidden">
        ...
        <div className="uppercase font-AlbertusNova-Regular pt-86px w-623px text-center text-[#E6E7E8] absolute z-10 top-1/2 left-1/2 translate-y-[-50%] translate-x-[-50%] text-40px pad:text-28px">
          <div className="flex flex-col justify-center items-center">
            <p className="whitespace-nowrap"> Bring the drinking</p>
            <p className="whitespace-nowrap"> occasion to life in a way</p>
          </div>
        </div>
      </div>
      ...
      <div className="pl-33px pr-33px mobile:pt-100px mobile:pl-0 mobile:pr-0">
        ...
        <div className="text-dark-grey pl-53px pr-53px pb-67px text-22px color-dark-grey font-normal leading-[2em] font-Grotesque-Regular mobile:text-14px mobile:pl-25px mobile:pr-25px mobile:pb-20px mobile:leading-[2em] mobile:flex mobile:flex-wrap">
          <p className="mobile:order-2">
            ...
            talking. Bring the drinking occasion to life in a way that gives us
            a place in culture and gets people talking. Bring the drinking
            occasion to life in a way that gives us a place in culture and gets
            people talking.{" "}
          </p>
        ...
        <p className="color-dark-grey text-22px font-normal leading-[1.5em] font-Grotesque-Regular pl-47px pr-47px pb-117px mobile:text-14px mobile:pl-25px mobile:pr-25px mobile:leading-[2em] mobile:pb-40px">
