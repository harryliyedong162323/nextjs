...
function ActivityDetailComponent(props: propsContent) {
  ...
  return (
    <div className="pl-33px pr-33px overflow-hidden mobile:pl-0 mobile:pr-0">
      ...
      <div className="text-dark-grey pl-53px pr-53px pb-67px text-22px color-dark-grey font-normal leading-[2em] font-Grotesque-Regular mobile:text-14px mobile:pl-25px mobile:pr-25px mobile:pb-20px mobile:leading-[2em] mobile:flex mobile:flex-wrap">
        <p className="mobile:order-2">
          Bring the drinking occasion to life in a way that gives us a place in
          culture and gets people talking.{" "}
        </p>
        <p className="mobile:order-1 mobile:pb-20px ">
          Bring the drinking occasion to life in a way that gives us a place in
          culture and gets people talking. Bring the drinking occasion to life
          in a way that gives us a place in culture and gets people talking.
          Bring the drinking occasion to life in a way that gives us a place in
          culture and gets people talking.
        </p>
      </div>
      ...
      <p className="color-dark-grey text-22px font-normal leading-[2em] font-Grotesque-Regular pl-47px pr-47px pb-117px mobile:text-14px mobile:pl-25px mobile:pr-25px mobile:leading-[2em] mobile:pb-82px">
        Bring the drinking occasion to life in a way that gives us a place in
        culture and gets people talking. Bring the drinking occasion to life in
        a way that gives us a place in culture and gets people talking.
      </p>

      <section className="flex justify-between pb-117px mobile:pb-10px mobile:flex-wrap">
        ...
        <div>
          <div className="color-dark-grey text-27px font-normal pb-33px font-AlbertusNova-Regular mobile:text-center mobile:text-16px mobile:pb-20px mobile:pt-20px">
            Bring the drinking occasion
          </div>
          <p className="color-dark-grey font-Grotesque-Regular text-22px font-normal pb-50px leading-[2em] mobile:pl-25px mobile:pr-25px mobile:pb-30px mobile:text-14px mobile:leading-[22px]">
          ...
          <p className="color-dark-grey font-Grotesque-Regular text-22px font-normal leading-[2em] mobile:pl-25px mobile:pr-25px mobile:pb-30px mobile:text-14px mobile:leading-[22px]">
            Bring the drinking occasion to life in a way that gives us a place
            in culture and gets people talking. Bring the drinking occasion to
            life in a way that gives us a place in culture and gets people
            talking.{" "}
      ...
      <section>
        ...
        <div className="relative overflow-hidden pb-33px mobile:pb-20px">
          ...
          <div className="w-full block h-667px relative mobile:h-588px">
            <BaseImage
      ...
      <section className="pb-132px flex justify-between mobile:flex-wrap mobile:justify-center mobile:hidden">
        <div className="mr-88px">
          ...
          <p className="pt-50px text-22px font-normal font-Grotesque-Regular color-dark-grey leading-[2em]">
            Bring the drinking occasion to life in a way that gives us a place
