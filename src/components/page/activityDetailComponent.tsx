...
function ActivityDetailComponent(props: any) {
    ...
    return (
        <div className="container mx-auto overflow-hidden">
            <div className="text-22px font-normal text-center text-dark-grey pt-95px pb-42px font-AlbertusNova-Regular mobile:pt-22px mobile:pb-20px mobile:text-14px uppercase">the Wild Escape Journal</div>
