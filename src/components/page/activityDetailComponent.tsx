...
function ActivityDetailComponent(props: any) {
    ...
    return (
        <div className="container mx-auto overflow-hidden">
            <div className="text-22px font-normal text-center text-dark-grey pt-95px pb-42px font-AlbertusNova-Regular mobile:pt-22px mobile:pb-20px mobile:text-14px uppercase paid:pt-150px">the Wild Escape Journal</div>
            ...
            <p className="color-dark-grey text-22px font-normal leading-[38px] font-Grotesque-Regular pl-47px pr-47px pb-117px mobile:text-14px mobile:pl-25px mobile:pr-25px mobile:leading-[22px] mobile:pb-82px">Bring the drinking occasion to life in a way that gives us a place in culture and gets people talking. Bring the drinking occasion to life in a way that gives us a place in culture and gets people talking.</p>
            ...
            <section className="pb-132px flex justify-between mobile:flex-wrap mobile:justify-center mobile:hidden">
                <div className="mr-88px">
                    ...
                    <p className="text-22px font-normal font-Grotesque-Regular color-dark-grey leading-[38px]">Bring the drinking occasion to life in a way that gives us a place in culture and gets people talking. Bring the drinking occasion to life in a way that gives us a place in culture and gets people talking. </p>
                    <p className="text-22px font-normal font-Grotesque-Regular color-dark-grey leading-[38px]">Bring the drinking occasion to life in a way that gives us a place in culture and gets people talking. Bring the drinking occasion to life in a way that gives us a place in culture and gets people talking.</p>
                    <p className="pt-50px text-22px font-normal font-Grotesque-Regular color-dark-grey leading-[38px]">Bring the drinking occasion to life in a way that gives us a place in culture and gets people talking.</p>
