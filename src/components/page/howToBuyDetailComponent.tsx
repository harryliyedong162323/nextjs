...
const Baidu: React.ComponentType<{}> = dynamic(
  () => import("@/components/map/baidu")
);
...
function HowToBuyDetailComponent(props: any) {
  ...
  return (
    <section className="w-full h-900px relative mobile:h-auto overflow-hidden">
      ...
      <div
        className={`w-[50%] pad:w-[70%] mobile:w-auto  pb-67px mobile:pt-67px mx-auto   opacity-1 `}
      >
        <div className="text-33px font-normal font-AlbertusNova-Regular pb-64px text-center pt-143px pad:pt-102px mobile:pt-42px mobile:text-24px mobile:leading-[40px] mobile:pb-45px uppercase">
          Servicing
        </div>
        <div className="font-normal whitespace-nowrap font-Grotesque-Regular text-22px text-center text-dark-grey leading-[1.5em] pad:text-15px mobile:whitespace-normal mobile:text-14px mobile:pl-25px mobile:pr-25px mobile:leading-[2em] flex justify-center">
          The Ancient Reserve is a diverse collection of rare, high-aged
          whiskies sourced and
          <br /> maintained over 6 decades by the Grant family. It includes
          casks from every region of
          <br /> Scotland, including some notable ghost distillery stocks.
        </div>
      </div>
