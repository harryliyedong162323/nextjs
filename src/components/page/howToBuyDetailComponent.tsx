...
function HowToBuyDetailComponent(props: any) {
    ...
    return (
       <section className="w-full h-screen">
           ...
           {/*<section className="">*/}
              <div className={`w-[50%] mobile:w-auto  pb-67px mobile:pt-67px mx-auto ease-in-out duration-1000 transition-all ${isCurrentPage ? 'translate-y-0 opacity-1' : 'translate-y-[-100%] opacity-0'}`}>
               ...
               <div className="absolute z-10 top-0 left-[0%] h-full w-200px bg-gradient-to-l from-[transparent] to-[#f6f6f6] mobile:hidden"></div>
