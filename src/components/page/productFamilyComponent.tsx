      ...
      <div className="w-full  min-h-[800px] h-screen">
          ...
          <div className="relative h-full w-full">
            ...
            <div className="an-group-1 w-full overflow-hidden absolute left-[44%] z-30 top-[50%] translate-y-[-50%] mobile:hidden">
              <div className="an-bottle w-989px  flex flex-nowrap items-start">
                <div className="w-[203px!ignore] h-[442px!ignore]  relative mr-130px pad:mr-64px mobile:w-102px mobile:h-223px ">
                  <BaseImage
                ...
                <div className="an-text text-white h-[442px!ignore]  flex flex-col justify-between  mobile:pl-23px mobile:pr-23px mobile:w-full pt-[105px!ignore] pad:pt-[111px!ignore] ">
                  <div className="font-AlbertusNova-Regular  font-normal mobile:text-center mobile:w-full mobile:pb-20px flex items-center pad:min-w-64 pad:w-250px">
                    <div className="relative flex items-center  flex-nowrap">
                      <span className="text-60px font-light font-AlbertusNova-Light  pad:text-55px pad:pb-5px mobile:text-38px">
                        {currentBottleData.age}
                      </span>
                      <p className="text-11px font-AlbertusNova-Regular absolute bottom-0 left-0 w-full text-center pad:text-left pad:whitespace-nowrap pad:text-10px mobile:text-7px uppercase">
                        {currentBottleData.unit}
                      </p>
                    </div>
                    <div className="mr-16px ml-9px pad:translate-y-[5px] translate-y-[7px] h-[70px!ignore] w-[2px!ignore] bg-white pad:mr-11px pad:ml-6px pad:h-[50px!ignore] mobile:ml-10px mobile:mr-6px  text-transparent">
                      |
                    </div>
                    <div className="flex flex-nowrap uppercase relative align-middle text-29px pt-20px   pad:text-25px pad:pt-14px mobile:text-19px mobile:w-125px">
                  ...
                  <div className="  w-426px text-20px font-Grotesque-Light font-normal  pad:w-378px pad:text-18px mobile:w-full mobile:text-center mobile:text-14px mobile:leading-[21px]">
                    {currentBottleData.description}
                  </div>
                  <div className="font-Grotesque-Regular font-normal text-21px pad:text-18px mobile:text-center mobile:text-16px">
        ...
        <div className="h-[30%] overflow-hidden">
          <div className="relative h-full w-full">
            ...
            <div className="absolute w-full  pl-50px pr-50px top-1/2 translate-y-[-50%]  mobile:top-1/2 mobile:translate-y-[-50%]  ">
              ...
              <div className="flex justify-between  h-[125px!ignore]   pb-11px  mobile:h-110px">
